...
public class CraftingPlus extends JavaPlugin {
    ...
    private void addRecipes(){
        ...
        new ShapedCraftingRecipe(this, "discCat", new ItemStack(Material.GREEN_RECORD, 1), new String[]{" O ", "OEO", " O "})
                .setIngredient('O', Material.OBSIDIAN).setIngredient('E', Material.EMERALD)
                .setup();

        new ShapedCraftingRecipe(this, "discBlocks", new ItemStack(Material.RECORD_3, 1), new String[]{" O ", "OBO", " O "})
                .setIngredient('O', Material.OBSIDIAN).setIngredient('B', Material.BRICK)
                .setup();

        new ShapedCraftingRecipe(this, "discChirp", new ItemStack(Material.RECORD_4, 1), new String[]{" O ", "ORO", " O "})
                .setIngredient('O', Material.OBSIDIAN).setIngredient('R', Material.REDSTONE)
                .setup();

        new ShapedCraftingRecipe(this, "discFar", new ItemStack(Material.RECORD_5, 1), new String[]{" O ", "OSO", " O "})
                .setIngredient('O', Material.OBSIDIAN).setIngredient('S', Material.SLIME_BALL)
                .setup();

        new ShapedCraftingRecipe(this, "discMall", new ItemStack(Material.RECORD_6, 1), new String[]{" O ", "OCO", " O "})
                .setIngredient('O', Material.OBSIDIAN).setIngredient('C', Material.CLAY)
                .setup();

        new ShapedCraftingRecipe(this, "discMellohi", new ItemStack(Material.RECORD_7, 1), new String[]{" O ", "OGO", " O "})
                .setIngredient('O', Material.OBSIDIAN).setIngredient('G', Material.GHAST_TEAR)
                .setup();

        new ShapedCraftingRecipe(this, "discStal", new ItemStack(Material.RECORD_8, 1), new String[]{" O ", "OCO", " O "})
                .setIngredient('O', Material.OBSIDIAN).setIngredient('C', Material.COAL)
                .setup();

        new ShapedCraftingRecipe(this, "discStrad", new ItemStack(Material.RECORD_9, 1), new String[]{" O ", "OQO", " O "})
                .setIngredient('O', Material.OBSIDIAN).setIngredient('Q', Material.QUARTZ)
                .setup();

        new ShapedCraftingRecipe(this, "discWard", new ItemStack(Material.RECORD_10, 1), new String[]{" O ", "OEO", " O "})
                .setIngredient('O', Material.OBSIDIAN).setIngredient('E', Material.EYE_OF_ENDER)
                .setup();

        new ShapedCraftingRecipe(this, "disc11", new ItemStack(Material.RECORD_11, 1), new String[]{" O ", "OCO", " O "})
                .setIngredient('O', Material.OBSIDIAN).setIngredient('C', Material.COAL, 1)
                .setup();

        new ShapedCraftingRecipe(this, "discWait", new ItemStack(Material.RECORD_12, 1), new String[]{" O ", "ODO", " O "})
                .setIngredient('O', Material.OBSIDIAN).setIngredient('D', Material.DIAMOND)
                .setup();

        new ShapedCraftingRecipe(this, "ironHorseArmor", new ItemStack(Material.IRON_BARDING, 1), new String[]{" O ", "ODO", " O "})
                .setIngredient('O', Material.OBSIDIAN).setIngredient('D', Material.DIAMOND)
                .setup();
        ...
        new ShapedCraftingRecipe(this, "ironHorseArmor", new ItemStack(Material.IRON_BARDING, 1), new String[]{"  I", "IBI", "III"})
                .setIngredient('I', Material.IRON_INGOT).setIngredient('B', Material.WOOL, 15)
                .setup();

        new ShapedCraftingRecipe(this, "goldHorseArmor", new ItemStack(Material.GOLD_BARDING, 1), new String[]{"  G", "GRG", "GGG"})
                .setIngredient('G', Material.GOLD_INGOT).setIngredient('R', Material.WOOL, 14)
                .setup();

        new ShapedCraftingRecipe(this, "diamondHorseArmor", new ItemStack(Material.DIAMOND_BARDING, 1), new String[]{"  D", "DBD", "DDD"})
                .setIngredient('D', Material.DIAMOND).setIngredient('B', Material.WOOL, 11)
                .setup();
        //</editor-fold>

        //<editor-fold desc ="Ice">
        new ShapedCraftingRecipe(this, "ice", new ItemStack(Material.ICE, 1), new String[]{"SSS", "SWS", "SSS"})
                .setIngredient('S', Material.SNOW_BALL).setIngredient('W', Material.WATER_BUCKET)
                .setup();

        new ShapelessCraftingRecipe(this, "packedIce", new ItemStack(Material.PACKED_ICE, 1))
                .addIngredient(4, Material.ICE)
                .setup();
        //</editor-fold>

        //<editor-fold desc ="Miscellaneous">
        new ShapedCraftingRecipe(this, "saddle", new ItemStack(Material.SADDLE, 1), new String[]{"LLL", "SLS", "I I"})
                .setIngredient('L', Material.LEATHER).setIngredient('S', Material.STRING)
                .setIngredient('I', Material.IRON_INGOT).setup();

        new ShapedCraftingRecipe(this, "nameTag", new ItemStack(Material.NAME_TAG, 1), new String[]{"  S", " P ", "P  "})
                .setIngredient('S', Material.STRING).setIngredient('P', Material.PAPER)
                .setup();

        new ShapedCraftingRecipe(this, "cobWeb", new ItemStack(Material.WEB, 1), new String[]{"SSS", "SBS", "SSS"})
                .setIngredient('S', Material.STRING).setIngredient('B', Material.SNOW_BALL)
                .setup();

        new ShapedCraftingRecipe(this, "mobSpawner", new ItemStack(Material.MOB_SPAWNER, 1), new String[]{"III", "IPI", "III"})
